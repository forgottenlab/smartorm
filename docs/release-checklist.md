...
|---|---|---|
| 35 database-independent regressions | 🧪 Locally Verified | Current parameter-binding preflight: 35/35 |
...
| Current fresh MySQL parameter-binding preflight | 🧪 Locally Verified | 2026-09-16: 47/47, real `BoundSql` mappings, residue 0/0/0 |
...
| Starter feature remote validation | ☁️ Remotely Verified | `pull_request` run `32653878401` passed Starter 21 and the then-current core 28/MySQL 46/package/report/cleanup gates; it predates the binding regression |
